...
def prepare_network(config):
    ...
    if not isinstance(config['scenario']['co2_reduction'], tuple):
        ...
        if config['scenario']['co2_reduction'] is not None:
            ...
            co2_limit = (5.92 + 0.62)*1e9 * (1 - config['scenario']['co2_reduction'][pathway][planning_horizons]) # Chinese 2020 CO2 emissions of electric and heating sector
